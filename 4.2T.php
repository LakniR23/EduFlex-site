...
<body>
    ...
    <h1 id="mod" align="center">Coding Projects and Problem-Solving</h1>
        ...
        <div class="box">
            ...
            <p id="l1"> Learning Outcomes:
                <button id="btn" onclick="location.href='content/18.pdf';">See more</button>
              </p>
              
            <p id="l2" class="class">Week 01</p>
            <p id="l4"> 1.Problem solving<br><button id="btn" onclick="location.href='content/19.pdf';">View PDF</button>
          
            <br>Watch this reference video<br>
           <button id="btn" onclick="window.open('https://youtu.be/vrmKwQ-JPTA?feature=shared', '_blank')">Watch</button>                  </p><br> <hr><br><br>
