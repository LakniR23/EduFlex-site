...
<html>
    ...
    <nav class="navbar">
        ...
        <h1 id="mod" align="center">Module Page-Diploma in Educational Technology(IT1010)</h1>

        <div class="module-container">
    <div class="module">
    <h2>1.Digital Tools for Classroom Innovation</h2>
    <p>This module introduces digital tools that help educators create engaging and innovative classroom experiences</p>

    <div style="display: flex; align-items: center;">
    <img src="images/mod.webp" alt="Lecturer" style="width: 50px; margin-right: 10px;">
    <p>Lecturer: Dr. S.R. Fernando</p>
    <a href="1.1T.php" class="view-button" style="margin-left: auto;">View</a>
    </div>   
   
  </div>
  
    <div class="module">
    <h2>2. Designing Engaging Learning Experiences</h2>
    <p>In this module, you will learn how to create interactive and inclusive learning experiences that inspire and motivate students through effective use of technology and diverse teaching strategies.

    </p>
    <div style="display: flex; align-items: center;">
    <img src="images/mod.webp" alt="Lecturer" style="width: 50px; margin-right: 10px;">
    <p>Lecturer: Dr. Rajiv Fernando</p>
    <a href="1.2T.php" class="view-button" style="margin-left: auto;">View</a>
        </div>   
    </div>
</div>
