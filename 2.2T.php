...
<body>
    ...
    <h1 id="mod" align="center"> Protecting Student Data and Communication</h1>
        
        
        <div class="box">
			<h2 id="title">Module Overview</h2>
			<p id="para2">
                This module is centered around creating engaging, interactive, and meaningful learning experiences using digital tools. Educators will learn how to design lessons that keep students actively involved, whether in-person or online. The focus will be on leveraging multimedia, gamification, and collaborative technologies to foster a participatory learning environment.</p>
			
     
            <p id="l1"> Learning Outcomes:
                <button id="btn" onclick="location.href='content/10.pdf';">See more</button>
              </p>
              
            <p id="l2" class="class">Week 01</p>
            <p id="l4"> 1.Digital Safety for Educators<br>

<button id="btn" onclick="location.href='content/11.pdf';">View PDF</button><br>
            
Watch this reference video<br>
            <button id="btn" onclick="window.open('https://youtu.be/N8xEgSe5RwE?feature=shared', '_blank')">Watch</button>                  </p><br> <hr><br><br>
