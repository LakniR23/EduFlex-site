...
<body>
    ...
    <h1 id="mod" style="text-align: center;">Designing Engaging Learning Experiences</h1>
...
<div class="box">
    ...
    <p id="l1"> Learning Outcomes:
        <button id="btn" onclick="location.href='content/5.pdf';">See more</button>
      </p>
      
    <p id="l2" class="class">Week 01</p>
    <p id="l4">1. Principles of Multimedia Learning <br><button id="btn" onclick="location.href='content/4.pdf';">View PDF</button>
    <br>Watch this reference video<br>
    <button id="btn" onclick="window.open('https://youtu.be/yASnmxVw8GI?feature=shared', '_blank')">Watch</button>                  </p><br> <hr><br><br>
