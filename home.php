...
<body>
    ...
    <div class="background">
        ...
        <main class="programs">
            ...
            <a href="programb.php"><button class="reso">Programs</button></a>
                <button class="reso" onclick="accepts()">Resources</button>
            </div>
        </main>
...
<!--events-->
        ...
        <main class="live-event-container">
            <a href="https://teams.live.com/meet/9374865603680?p=5FhacaJjHk5xIo2SJQ">
            ...
            <a href="https://teams.live.com/meet/9374865603680?p=5FhacaJjHk5xIo2SJQ"><section class="live-event">
                <img src="images/live.png" alt="Live Event 2"></a>
                <h2>Live Event 2</h2>
