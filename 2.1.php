...
<a href="edit.php?Id=$res_id" class="profile-link">Profile</a>
		...
		<h1 id="mod"> Digital Security Essentials for Educators</h1>
        ...
        <div class="box">
            ...
            <button id="btn" onclick="location.href='content/8.pdf';">See more</button>
            </p>
              
            <p id="l2" class="class">Week 01</p>
            <p id="l4">1. Digital Security Guidelines<br><button id="btn" onclick="location.href='content/9.pdf';">View PDF</button>
      
           <br> Watch this reference video<br>
            <button id="btn" onclick="window.open('https://youtu.be/867tece6KZk?feature=shared', '_blank')">Watch</button>                  </p><br> <hr><br><br>
